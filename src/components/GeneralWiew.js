...
class GeneralWiew extends Component {
    ...
    changeCategory = (newCategory) => {
        this.setState({
            ...
            movies: movieCategoryTop5[newCategory]
        })
    }

    render() {

        const classToggle = this.state.display ? "my-5 text-center" : "d-none"
        ...
        return (
            ...
            <div className="mt-5">
                <CardGroup>
                    {
                        categories.map( item =>
                            ...
                            <Categories
                                ...
                                getCategory={this.changeCategory}       
                            />
                        )
                    }                            
                </CardGroup>

                <Table className={classToggle} striped bordered hover >
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Movie Name</th>
                ...
                <tbody className="text-center">
                    <TableTop5 movieList={this.state.movies}/>
                </tbody>
            </Table> 
            </div>
        )
